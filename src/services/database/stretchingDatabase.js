...
class StretchingDatabase {
      ...
      stretching_exercises: [
        {
          ...
          description:
            'Stand tall with one heel on a slightly elevated surface (like a step or low bench). Keep your leg straight but not locked. Hinge forward at your hips, keeping your back straight, until you feel a stretch in the back of your thigh. Hold for the recommended duration.',
          type: 'Static',
        ...
        },
        {
          ...
          description:
            'Stand tall and hold onto a wall or chair for balance if needed. Grab your right ankle with your right hand and gently pull your heel towards your glutes. Keep your knees close together and your torso upright. Feel the stretch in the front of your thigh. Hold for the recommended duration, then switch legs.',
          type: 'Static',
        ...
        },
        {
          ...
          description:
            "Stand facing a wall, about arm's length away. Place your hands on the wall at shoulder height. Step one foot back, keeping both heels on the ground and your back leg straight. Lean into the wall, feeling the stretch in your calf. Hold for the recommended duration, then switch legs.",
          type: 'Static',
          primary_muscle_groups: ['Calves'],
          secondary_muscle_groups: [],
          purpose: ['Flexibility', 'Cool-down'],
          equipment_needed: true,
          equipment_details: ['Wall'],
          difficulty_level: 'Beginner',
          duration_seconds: 30,
          repetitions: 1,
          sets: 2,
        ...
        },
        {
          ...
          description:
            'Stand or sit tall. Raise one arm overhead, then bend your elbow, letting your hand drop behind your head towards your opposite shoulder blade. Use your other hand to gently push down on the elbow of the stretching arm, deepening the stretch. Hold for the recommended duration, then switch arms.',
          type: 'Static',
          ...
          image_urls: [],
          cautions:
            'Avoid pulling too hard on your elbow. Keep your neck relaxed.',
        },
        {
          exercise_id: '7fa1ae59-4b5c-4d2d-b810-73add9a688fc',
          name: 'Shoulder Rolls (Dynamic)',
          description:
            'Stand tall with arms relaxed at your sides. Slowly roll your shoulders forward in a circular motion for several repetitions, then reverse the direction and roll them backward. Focus on smooth, controlled movements.',
          type: 'Dynamic',
        ...
        },
        {
          ...
          description:
            'Stand tall, holding onto a wall or sturdy object for balance. Swing one leg forward and backward in a controlled motion, gradually increasing the height of the swing. Keep your core engaged and avoid arching your back. Perform for recommended repetitions, then switch legs.',
          type: 'Dynamic',
          primary_muscle_groups: ['Hamstrings', 'Quadriceps', 'Hip Flexors'],
          ...
          image_urls: [],
          cautions:
            'Maintain control throughout the movement. Do not force the range of motion.',
        },
        {
          exercise_id: 'bf563c7b-950f-4337-a5c6-6a5f701142fd',
          name: 'Cat-Cow Stretch',
          description:
            'Start on your hands and knees in a tabletop position. Inhale as you drop your belly towards the mat, lifting your chin and chest to look up (Cow). Exhale as you round your spine towards the ceiling, tucking your chin to your chest (Cat). Repeat for the recommended repetitions.',
          type: 'Dynamic',
          primary_muscle_groups: ['Spine', 'Core'],
          secondary_muscle_groups: ['Neck', 'Shoulders'],
          purpose: ['Warm-up', 'Flexibility'],
          equipment_needed: false,
          difficulty_level: 'Beginner',
          duration_seconds: null,
          repetitions: 10,
          ...
          image_urls: [],
          cautions:
            'Move with your breath and avoid forcing the range of motion.',
        },
        {
          exercise_id: 'df1bcc7a-0a42-4f07-8661-632931ec8b1d',
          name: "Child's Pose",
          description:
            'Kneel on the floor, sit back on your heels, and then fold forward, resting your forehead on the floor. Your arms can be stretched out in front of you or resting alongside your body. Breathe deeply and relax.',
          type: 'Static',
          primary_muscle_groups: ['Lower Back', 'Hips'],
          secondary_muscle_groups: ['Shoulders'],
          purpose: ['Flexibility', 'Cool-down', 'Rehabilitation'],
          equipment_needed: false,
          difficulty_level: 'Beginner',
          duration_seconds: 60,
          repetitions: 1,
          ...
          image_urls: [],
          cautions:
            'If you have knee issues, place a blanket under your knees for support.',
        },
        {
          exercise_id: '9e335631-074d-4bc6-a49e-84fadd7ff46d',
          name: 'Butterfly Stretch',
          description:
            'Sit on the floor with the soles of your feet together and your knees bent out to the sides. Hold onto your ankles or feet, and gently press your knees towards the floor. Keep your back straight.',
          type: 'Static',
          primary_muscle_groups: ['Inner Thighs', 'Hips'],
          secondary_muscle_groups: ['Groin'],
          purpose: ['Flexibility'],
          equipment_needed: false,
          difficulty_level: 'Beginner',
          duration_seconds: 30,
        ...
        },
        {
          ...
          description:
            'Lie on your back with your knees bent and feet flat on the floor. Bring one knee to your chest, holding it with both hands. Gently pull the knee closer to your chest. Hold, then switch legs.',
          type: 'Static',
          primary_muscle_groups: ['Lower Back', 'Glutes'],
      ...
      stretching_routines: [
        {
          ...
          description:
            'A gentle routine to wake up your muscles and improve circulation, perfect for starting your day.',
          purpose: ['Daily Flexibility', 'Warm-up'],
          ...
          tags: ['Morning', 'Full Body', 'Gentle'],
        },
        {
          routine_id: '19ba84af-a3e6-4d78-943d-ea85fcaf04df',
          name: 'Post-Run Cool-down',
          description:
            'A routine focused on static stretches to aid recovery and improve flexibility after a run.',
          purpose: ['Cool-down', 'Flexibility', 'Sport-Specific'],
          ...
          tags: ['Running', 'Recovery', 'Legs'],
        },
        {
          routine_id: 'cb73c37a-c059-4362-b237-bd82671891ec',
          name: 'Office Desk Relief',
          description:
            'A short routine to combat the effects of sitting at a desk all day.',
          purpose: ['Flexibility', 'Rehabilitation'],
        ...
        },
        {
          ...
          tags: ['Workout', 'Dynamic', 'Warm-up'],
        },
        {
          routine_id: 'ee5181e1-0231-4f79-ae3c-d8acf33929af',
          name: 'Advanced Flexibility Flow',
          description:
            'A challenging routine for those looking to improve their flexibility significantly.',
          purpose: ['Flexibility'],
          ...
          tags: ['Advanced', 'Flexibility', 'Yoga'],
        },
      ],
    };
  }
  ...
  getAllExercises(filters = {}) {
    const { type, difficulty, muscleGroup, purpose, equipment, search } =
      filters;
    ...
    return this.data.stretching_exercises.filter(exercise => {
      ...
      if (search) {
        ...
        const descMatch = exercise.description
          .toLowerCase()
  ...
  getExerciseById(exerciseId) {
    return this.data.stretching_exercises.find(
  ...
  getExercisesByType(type) {
    return this.data.stretching_exercises.filter(
  ...
  getExercisesByDifficulty(difficultyLevel) {
    return this.data.stretching_exercises.filter(
      exercise => exercise.difficulty_level === difficultyLevel
    );
  }
  ...
  getAllRoutines(filters = {}) {
    ...
    return this.data.stretching_routines.filter(routine => {
      ...
      if (duration && routine.estimated_duration_minutes > duration)
        return false;
      ...
      if (search) {
        ...
        const descMatch = routine.description
          .toLowerCase()
          .includes(lowerSearch);
        const tagMatch =
          routine.tags &&
          routine.tags.some(tag => tag.toLowerCase().includes(lowerSearch));
  ...
  getRoutineById(routineId) {
    return this.data.stretching_routines.find(
  ...
  getRoutinesByDifficulty(difficultyLevel) {
    return this.data.stretching_routines.filter(
      routine => routine.difficulty_level === difficultyLevel
    );
  }
  ...
  getRoutinesByDuration(maxDuration) {
    return this.data.stretching_routines.filter(
      routine => routine.estimated_duration_minutes <= maxDuration
    );
  }
  ...
  getDetailedRoutine(routineId) {
    ...
    const detailedExercises = routine.exercises
      .map(exerciseRef => {
        ...
        return {
          ...
          duration_seconds:
            exerciseRef.duration_seconds || exercise.duration_seconds,
  ...
  createPersonalizedRoutine(criteria) {
    ...
    let availableExercises = this.data.stretching_exercises.filter(exercise => {
      ...
      if (muscleGroups.length > 0) {
        const hasTargetMuscle = muscleGroups.some(
          muscle =>
