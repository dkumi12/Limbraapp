      ...
      >
        ...
        <div style={{ textAlign: 'left' }}>
          <h1
            ...
            style={{ fontSize: '1.2rem', marginBottom: 0, textAlign: 'left' }}
          >
            {displayName || 'User'}
          </h1>
          <p
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {Math.round(localStats.totalTimeSpent / 60)}
            </div>
        ...
        >
          <div>
            <div
              style={{ color: '#166534', fontSize: '0.9rem', fontWeight: 600 }}
            >
              {localStats.streakDays}-day stretch streak
            </div>
            <div style={{ color: '#15803d', fontSize: '0.75rem' }}>
              Keep it going — share your progress
            </div>
          </div>
            ...
            >
              <div
                style={{
                  ...
                  gap: '0.75rem',
                  alignItems: 'center',
                  color: item.isUser ? '#166534' : '#334155',
                  fontSize: '0.9rem',
              ...
              <div
                style={{
                  fontSize: '0.85rem',
                  fontWeight: 500,
                  color: item.isUser ? '#166534' : '#64748b',
                }}
              >
                {item.streak} days
              </div>
        ...
        >
          <div>
            <div
              style={{ fontSize: '0.9rem', fontWeight: 500, color: '#334155' }}
            >
              Share my routines publicly
            </div>
            <div style={{ fontSize: '0.75rem', color: '#64748b' }}>
              Let others discover your saved stretches
            </div>
          </div>
          <div
            onClick={async () => {
