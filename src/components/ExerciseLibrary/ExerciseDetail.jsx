      ...
      >
        ...
        >
              ...
              style={{
                ...
                backgroundColor:
                  exercise.difficulty_level.toLowerCase() === 'beginner'
                    ? '#22c55e'
                    : exercise.difficulty_level.toLowerCase() === 'intermediate'
                      ? '#f59e0b'
                      : '#ef4444',
                color: 'white',
              }}
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <p style={{ color: '#b0b8c9', lineHeight: '1.6' }}>
          ...
          {exercise.equipment_needed && (
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                {exercise.equipment_details &&
                  exercise.equipment_details.map(equipment => (
                    <span
                      key={equipment}
                      style={{
                        padding: '0.25rem 0.75rem',
