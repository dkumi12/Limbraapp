...
The app now uses a modern, clean design system inspired by Material Design principles with a custom
color scheme.
...
All styling is contained in `src/theme.css`. The app uses CSS custom properties (variables) for easy
theme customization.
